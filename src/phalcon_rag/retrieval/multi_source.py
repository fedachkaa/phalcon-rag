...
class MultiSourceRetriever:
    ...
    def search(
        ...
        docs_results = self.docs_retriever.search(query, candidate_k=candidate_k, top_k=top_k)
        source_results = self.source_retriever.search(query, candidate_k=candidate_k, top_k=top_k)
